...
begin
	...
	begin
        ...
        w_reset <= '0';
        wait for k_clk_period;
        assert (w_lights_L = "000" and w_lights_R = "000") report "should stay off after reset" severity failure;
        ...
        wait for k_clk_period;
        assert (w_lights_L = "000" and w_lights_R = "000") report "right did not return off" severity failure;
        ...
        w_reset <= '0';
        wait for k_clk_period;
        assert (w_lights_L = "111" and w_lights_R = "111") report "bad hazard start" severity failure;
    
        wait for k_clk_period;
        assert (w_lights_L = "000" and w_lights_R = "000") report "bad hazard end" severity failure;
    
        -- change input in middle of right pattern
        w_left  <= '0';
        w_right <= '1';
        w_reset <= '0';
        wait for k_clk_period;
